...
**Refunds and manual changes.** Refund a payment in the Razorpay dashboard and, once the refund goes through, the `refund.processed` webhook takes back exactly the Pro time that payment bought; anything bought separately is kept, and with nothing left the account goes straight back to Free. A partial refund leaves Pro alone until refunds on that payment add up to the full amount. To change a plan by hand:
